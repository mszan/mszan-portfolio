...
export const Work = () => {
    return (
        <div id="work" className={workClasses.wrapper}>
            <Card
                id="portfolio"
                title="My Portfolio"
                description={
                    <p>
                        Dockerized website built with <b>NextJS</b> that
                        describes me, displays my projects and allows users to
                        contact me.
                    </p>
                }
            ...
            <Card
                ...
                description={
                    <p>
                        Dockerized real-time web chat app built with{" "}
                        <b>ReactJS</b>, <b>Django Rest Framework</b>,{" "}
                        <b>WebSockets</b> and <b>Postgres</b>. Users can create
                        private rooms and invite others to chat in real-time.
                    </p>
                }
            ...
            <Card
                ...
                description={
                    <p>
                        Dockerized web app built that allows users to add,
                        modify and delete tasks. Backend uses <b>ExpressJS</b>{" "}
                        along with <b>MySQL</b> and <b>JWT</b>. Frontend uses{" "}
                        <b>ReactJS</b> along with <b>Ant Design</b> and{" "}
                        <b>Ant Motion.</b>
                    </p>
                }
            ...
            <Card
                ...
                description={
                    <p>
                        Dockerized web web app built for a photographer built
                        with <b>Django</b> (both backend and frontend) and{" "}
                        <b>Postgres</b>. It allows users to view photo galleries
            ...
            <Card
                ...
                description={
                    <p>
                        Simple architect portfolio built with <b>React.</b>
                    </p>
                }
            ...
            <Card
                ...
                description={
                    <p>
                        Simple fully-responsive portfolio website built with{" "}
                        <b>pure HTML, CSS and JS</b>.
                    </p>
                }
            ...
            <Card
                ...
                description={
                    <p>
                        Dockerized online marketplace web application built with{" "}
                        <b>Django</b> (both backend and frontend) and{" "}
                        <b>MySQL</b> that handles offers announcements
                        displaying and allows their management.
                    </p>
                }

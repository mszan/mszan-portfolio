        ...
        return (
            <div className={aboutClasses.aboutWrapper}>
                <div className={aboutClasses.aboutContent}>
                    ...
                    <p>Hi there, I am 21 years old IT Management extramural student and I am in my second year now. In my current profession as <span>IT Specialist</span> I have developed mostly in <span>network management, systems maintenance</span> and <span>end-user support provision.</span></p>

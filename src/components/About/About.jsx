        ...
        return (
            <div className={aboutClasses.aboutWrapper}>
                <div className={aboutClasses.aboutContent}>
                    ...
                    <p>I am 21 years old IT Management extramural student and I am in my second year now. In my current profession as <span classNam>IT Specialist</span> I have developed mostly in <span classNam>network management, systems maintenance</span> and <span>end-user support provision.</span></p>
                    <hr style={{margin: "50px 0"}}/>
                    <p><span>I am currently looking for my first full-time job as a Junior Web / Frontend Developer.</span></p>
                    <p><br />Even though, at one time or another, I work with code in my full-time job, this is not as regular and amplifying as I want it to be in the nearest future. My daily routine includes developing several applications in <span>HTML, CSS</span> and <span>SQL</span>.</p>

    ...
    return (
        <div id="about" className={aboutClasses.wrapper}>
            <div className={aboutClasses.content}>
                ...
                <p>
                    Hello, I am 24 years old tech enthusiast with almost 3 years
                    of commercial experience as a <span>Backend Developer</span>
                    . Formerly served as an IT Administrator. On weekends I
                    study CS at master's level.
                </p>
                <p>
                    Most of my coding experience revolves around{" "}
                    <span>TypeScript</span> and
                    <span> NestJS</span>, but given my proven track record as a
                    swift learner, there is no stack or tool that daunts me.
                    There are many technologies I am already familiar with and
                    you can find them listed in my <a href="/cv.pdf">CV</a>.
                </p>
                <br />

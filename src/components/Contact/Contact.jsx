...
export class Contact extends React.Component {
    ...
    didUserSendEmailLately = () => {
        ...
        const timeLastEmailSent = moment(
            process.browser ? localStorage.getItem("timeLastEmailSent") : null
        );
    ...
    formBtnStateHandler = () => {
        if (
            this.state.formName === "" || // If form field formName is empty.
            ...
            this.setState({ formBtnDisabled: false });
        }
    };
    ...
    formChangeHandler = (event) => {
        ...
        if (name === "formEmail") {
            ...
            if (re.test(val)) {
                ...
                this.setState({ formEmailValid: false });
            }
        } else {
            this.setState({ [name]: val });
        }
    ...
    sendEmail = () => {
        ...
        send("default_service", "template_01r47bf", {
            ...
            localStorage.setItem("timeLastEmailSent", moment().format())
        );
    };
    ...
    render() {
        ...
        return (
            <React.Fragment>
                <motion.div id="contact" className={contactClasses.wrapper}>
